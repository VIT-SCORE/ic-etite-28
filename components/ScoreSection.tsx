  ...
  return (
    <section id={SCORE.id} className="mx-auto max-w-7xl px-5 py-12 lg:px-8 lg:py-16">
      ...
      <div className="grid gap-6 lg:grid-cols-[0.75fr_1.25fr]">
        <Reveal>
          <EventImageCard title="SCORE Activities" subtitle="SCORE · PHOTO AREA" aspectRatio="landscape" />
        </Reveal>
        <Reveal className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-6 md:p-7">
          ...
          <p className="text-[0.92rem] leading-relaxed text-secondary">{SCORE.body}</p>
        ...
        <Reveal delay={0.1} className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-6 md:p-7">
          ...
          <p className="text-[0.92rem] leading-relaxed text-secondary">
            {SCORE.society.body}
          </p>
        </Reveal>
      </div>
